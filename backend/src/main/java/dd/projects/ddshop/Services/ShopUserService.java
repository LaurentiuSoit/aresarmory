...
import dd.projects.ddshop.Repositories.ShopOrderDao;
        ...
        try {
            ...
            if (optional.isPresent()) {
                ...
                if (!Objects.isNull(cart)) {
                    shopOrderDao.deleteAll(shopOrderDao.getOrdersByUser(id));
                    cartDao.deleteById(cartDao.findByUserId(id).getId());
